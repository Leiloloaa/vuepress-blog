...
export function patch(oldVnode, vnode) {
  ...
  if (isRealElement) {
    ...
    // oldVnode是虚拟dom就是更新过程 使用diff算法
    if (oldVnode.tag !== vnode.tag) {
      // 如果新旧标签不一致 用新的替换旧的oldVnode.el代表的是真实dom节点--同级比较
...
- diff 只进行同级比较
![](http://198.52.110.135/images/%E6%BA%90%E7%A0%81%E7%AF%87/diff1.png)
- 根据新老 vnode 子节点不同情况分别处理
![](http://198.52.110.135/images/%E6%BA%90%E7%A0%81%E7%AF%87/diff2.png)
...
- 使用双指针移动来进行新老节点的对比
![](http://198.52.110.135/images/%E6%BA%90%E7%A0%81%E7%AF%87/diff3.png)
...
![](http://198.52.110.135/images/%E6%BA%90%E7%A0%81%E7%AF%87/diff4.png)
...
![](http://198.52.110.135/images/%E6%BA%90%E7%A0%81%E7%AF%87/diff5.png)

vue2中对于纯静态节点也有优化，但是上面demo中由于只有一层纯文字静态节点，所以未判定为static，套一层div后就会标记为static，之后进入patch阶段会判定是静态节点直接return。 vue3中patch则只会比较dynamicChildren节点，静态节点不能进入patch

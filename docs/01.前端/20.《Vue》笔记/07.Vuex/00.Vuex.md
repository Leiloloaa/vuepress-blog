---
title: Vuex
date: 2021-04-30 14:18:52
permalink: /pages/14c0f2/
categories:
  - 前端
  - 《Vue》笔记
  - Vuex
...
> `Vuex`是实现组件全局状态（数据）管理的一种机制，可以方便的实现组件之间的数据的共享

[![image.png](https://images.dbabox.ltd/images/2021/04/30/image.png)](https://images.dbabox.ltd/image/y1Kn)

## 使用 Vuex 统一管理状态的好处

- 易于开发和后期维护，能够在 vuex 中集中管理共享的数据
- 提高开发效率，能够高效的实现组件之间的数据共享
- 数据响应式，存储在 vuex 中的数据都是响应式的

> 一般情况下，只有组件之间共享的数据，才有必要储存到 vuex 中，对于组件中的私有数据，依旧存储在组件自身的 data 中
